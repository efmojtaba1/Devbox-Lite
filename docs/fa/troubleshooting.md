...
* [مشکلات Docker](#مشکلات-docker)
  ...
  * ‏[Image Build نمی‌شود](#ایمیج-build-نمیشود)
  * [فضای دیسک پر است](#فضای-دیسک-پر-است)
* [مشکلات VS Code](#مشکلات-vs-code)
  * [ادیتور (VS Code) به کانتینر وصل نمی‌شود](#ادیتور-به-کانتینر-وصل-نمیشود)
...
* [مشکلات ابزارها](#مشکلات-ابزارها)
  ...
  * [کامپوزر خطا می‌دهد](#کامپوزر-خطا-میدهد)
...
* [احراز هویت GitHub](#احراز-هویت-github)
  * [روش ۱: SSH Key (توصیه شده)](#روش-۱-ssh-key)
