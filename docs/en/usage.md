...
* [Creating Projects](#creating-projects)
  * [Recommended: `new-project` (interactive, offline-first)](#recommended-new-project)
...
* [Auto-Setup Databases](#auto-setup-databases)
  ...
  * [Connection Info (inside container)](#connection-info)
  * [Laravel `.env` Configuration](#laravel-env-configuration)
  * [Laravel with React/Vite (Starter Kits)](#laravel-with-reactvite)
